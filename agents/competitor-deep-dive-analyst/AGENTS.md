...
there, fall back to the repo-root `agents/competitor-deep-dive-analyst/...` paths listed above.
...
post-Gate-A Product Bet state machine; competitor deep dive is a Product Bet
section, not a Gate B recommendation.
