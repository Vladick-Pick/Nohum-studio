...
- `agents/launch-program-manager/SOUL.md`
- `agents/launch-program-manager/HEARTBEAT.md`
- `agents/launch-program-manager/TOOLS.md`
...
there, fall back to the repo-root `agents/launch-program-manager/...` paths listed above.
