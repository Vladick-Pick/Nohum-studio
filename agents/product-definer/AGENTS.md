...
- `agents/product-definer/SOUL.md`
- `agents/product-definer/HEARTBEAT.md`
- `agents/product-definer/TOOLS.md`
...
there, fall back to the repo-root `agents/product-definer/...` paths listed above.
