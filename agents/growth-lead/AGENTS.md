...
- `agents/growth-lead/SOUL.md`
- `agents/growth-lead/HEARTBEAT.md`
- `agents/growth-lead/TOOLS.md`
...
there, fall back to the repo-root `agents/growth-lead/...` paths listed above.
