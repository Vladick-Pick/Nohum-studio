...
- `agents/community-builder/SOUL.md`
- `agents/community-builder/HEARTBEAT.md`
- `agents/community-builder/TOOLS.md`
...
there, fall back to the repo-root `agents/community-builder/...` paths listed above.
