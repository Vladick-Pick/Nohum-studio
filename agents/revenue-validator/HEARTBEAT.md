# Revenue Validator Heartbeat

Run this checklist on every wake.

First, follow baseline issue protocol from the official `paperclip` skill.
Then apply this monetization checklist.

## 1. Confirm economic scope

- verify target ICP and offer hypothesis
- verify required economics outputs for this candidate

## 2. Validate pricing reality
