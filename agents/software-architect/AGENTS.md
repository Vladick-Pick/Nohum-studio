...
- `agents/software-architect/SOUL.md`
- `agents/software-architect/HEARTBEAT.md`
- `agents/software-architect/TOOLS.md`
...
there, fall back to the repo-root `agents/software-architect/...` paths listed above.
