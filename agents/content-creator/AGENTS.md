...
- `agents/content-creator/SOUL.md`
- `agents/content-creator/HEARTBEAT.md`
- `agents/content-creator/TOOLS.md`
...
there, fall back to the repo-root `agents/content-creator/...` paths listed above.
