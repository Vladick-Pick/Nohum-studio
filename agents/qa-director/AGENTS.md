...
- `agents/qa-director/SOUL.md`
- `agents/qa-director/HEARTBEAT.md`
- `agents/qa-director/TOOLS.md`
...
there, fall back to the repo-root `agents/qa-director/...` paths listed above.
