---
name: venture-policy
description: Core policy for operating the NoHum Studio venture factory
---
...
- company budget is a hard cap unless board overrides it
- `build_start_at` starts the 14-day timer
