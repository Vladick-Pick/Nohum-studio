...
const requiredProductBetNestedLoopChecks = [
  {
    ...
    tokens: [
      ...
      "first_view_containment",
      "test_framing_absence",
  ...
  },
  {
    ...
    tokens: [
      ...
      "first-view containment",
      "test/proposed framing absence",
  ...
  {
    file: "docs/product-bets/README.md",
    tokens: [
      "board_review_preview_available",
  ...
  {
    file: "agents/landing-surface-builder/HEARTBEAT.md",
    tokens: [
      "Do not require a measurement plan before the first surface",
      "first_view_containment",
      "test_framing_absence",
      "form_completion_friction",
    ],
  ...
  {
    file: "agents/ui-designer/HEARTBEAT.md",
    tokens: [
      "visual_conversion_review",
      "first_view_containment",
      "board-review preview",
      "hero cannot be understood inside a common laptop first",
      "publication, measurement, traffic, observation, or Gate",
    ],
  },
  {
    file: "agents/ux-architect/HEARTBEAT.md",
    tokens: [
      "visual_conversion_review",
      "test_framing_absence",
      "form_completion_friction",
  ...
  {
    file: "docs/templates/product-bets/visual-conversion-review.md",
    tokens: [
      "First-view containment",
      "Test/proposed framing absence",
      "Form completion friction",
