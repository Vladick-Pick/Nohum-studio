---
name:
description: Use when scoring how close a validation risk test result is to real payment evidence.
---
...
Score how close a validation risk test result is to real payment evidence.
