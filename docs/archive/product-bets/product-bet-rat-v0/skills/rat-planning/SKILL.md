---
name: rat-planning
description: Use when creating Product Bet Validation validation risk test plans.
---

# Validation Risk Test Planning

## Purpose

Choose the cheapest decision-changing test for the selected validation risk.
