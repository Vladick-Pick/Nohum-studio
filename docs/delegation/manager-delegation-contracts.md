...
| `Research Lead` | raw idea enters research or queued item needs refresh | `Competitor Scout`, `Demand Validator`, `Revenue Validator`, `Research Synthesizer` | evidence packets and canonical queue package | same day for queue refresh, within 48 hours for new research | `CEO` on queue-quality ambiguity |
